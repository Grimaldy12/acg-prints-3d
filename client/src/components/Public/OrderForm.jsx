        ...
        <div className="pf-page">
          ...
          <div className="pf-wrap">
            <div className="pf-card" style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#4C5249', marginBottom: 20, lineHeight: 1.6 }}>
        ...
        <div className="pf-wrap">
          <div className="pf-card">
            ...
            <form onSubmit={handleSubmit}>
              <SectionLabel icon={<User size={13} />} text="Datos personales" />

              <div className="pf-row">
                <Field label="Nombre *">
                  <input className="pf-input" type="text" placeholder="Ej. Juan" value={form.customer_name} onChange={e => set('customer_name', e.target.value)} required />
                </Field>
                <Field label="Apellido *">
                  <input className="pf-input" type="text" placeholder="Ej. Pérez" value={form.customer_lastname} onChange={e => set('customer_lastname', e.target.value)} required />
                </Field>
              </div>

              <div className="pf-row">
                <Field label="Celular *">
                  <input className="pf-input" type="tel" placeholder="Ej. 6000-0000" value={form.customer_phone} onChange={e => set('customer_phone', e.target.value)} required />
                </Field>
                <Field label="Cédula">
                  <input className="pf-input" type="text" placeholder="Ej. 8-000-0000" value={form.customer_cedula} onChange={e => set('customer_cedula', e.target.value)} />
                </Field>
              </div>

              <SectionLabel icon={<Truck size={13} />} text="Compañía de envío" top />
              ...
              <SectionLabel icon={<Package size={13} />} text="Detalle del pedido" top />
              ...
              <button type="submit" className="pf-btn-primary" disabled={loading || !form.customer_company}>
                {loading
  ...
  return (
    <div className="pf-header">
      <div className="pf-header-inner">
        <img src="/logo.jpg" alt="ACG" className="pf-logo-img" onError={e => { e.target.style.display='none'; }} />
        <div>
...
function SectionLabel({ icon, text, top }) {
  return (
    <div className="pf-section-label" style={top ? { marginTop: 20 } : {}}>
      {icon} {text}
    </div>
  );
}
...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pf-header {
    background: #12181F;
    border-bottom: 3px solid #E2570F;
  }
  .pf-header-inner {
    max-width: 600px;
    margin: 0 auto;
  ...
  .pf-input:focus {
    border-color: #E2570F;
    box-shadow: 0 0 0 3px rgba(226,87,15,0.12);
  }
  .pf-textarea {
    resize: vertical;
    min-height: 80px;
  ...
  .pf-summary-label { font-weight: 600; color: #79806F; }
